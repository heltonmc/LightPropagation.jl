...
BenchmarkTools.Trial: 
  memory estimate:  9.89 MiB
  allocs estimate:  2975
  --------------
  minimum time:     4.425 ms (0.00% GC)
  median time:      4.496 ms (0.00% GC)
  mean time:        4.975 ms (4.38% GC)
  maximum time:     14.663 ms (0.00% GC)
  --------------
  samples:          1005
  evals/sample:     1
...
BenchmarkTools.Trial: 
  ...
  allocs estimate:  2901
  --------------
  minimum time:     1.649 ms (0.00% GC)
  median time:      1.678 ms (0.00% GC)
  mean time:        1.782 ms (4.37% GC)
  maximum time:     3.919 ms (31.13% GC)
  --------------
  samples:          2804
  evals/sample:     1
