...
@test fluence_DA_semiinf_CW(0.0, 0.1, 10.0) ≈ fluence_DA_Nlay_cylinder_CW(cylinder_data, besselroots[1:10000])

# ρ = 1.0 cm
cylinder_data = Nlayer_cylinder(ρ = 1.0, a = 100.0, l = [10.0, 10.0, 10.0, 10.0])
@test fluence_DA_semiinf_CW(1.0, 0.1, 10.0) ≈ fluence_DA_Nlay_cylinder_CW(cylinder_data, besselroots[1:10000])

# ρ = 4.0 cm
cylinder_data = Nlayer_cylinder(ρ = 4.0, a = 100.0, l = [10.0, 10.0, 10.0, 10.0])
@test fluence_DA_semiinf_CW(4.0, 0.1, 10.0) ≈ fluence_DA_Nlay_cylinder_CW(cylinder_data, besselroots[1:10000])
...
@test isapprox(fluence_DA_semiinf_CW(8.0, 0.1, 10.0), fluence_DA_Nlay_cylinder_CW(cylinder_data, besselroots[1:10000]), rtol=1e-6)
...
@test fluence_DA_Nlay_cylinder_CW(cylinder_4, besselroots[1:10000]) ≈  fluence_DA_Nlay_cylinder_CW(cylinder_3, besselroots[1:10000])  ≈ fluence_DA_Nlay_cylinder_CW(cylinder_2, besselroots[1:10000])
...
@test fluence_DA_Nlay_cylinder_CW(cylinder_4, besselroots[1:10000]) ≈  fluence_DA_Nlay_cylinder_CW(cylinder_5, besselroots[1:10000]) ≈  fluence_DA_Nlay_cylinder_CW(cylinder_8, besselroots[1:10000])
...
@test fluence_DA_semiinf_CW(1.0, 0.1, 60.0) ≈ fluence_DA_Nlay_cylinder_CW(cylinder_data, besselroots[1:10000])
...
@test fluence_DA_Nlay_cylinder_CW(cyl_4, besselroots[1:10000]) ≈ fluence_DA_Nlay_cylinder_CW(cyl_3, besselroots[1:10000]) ≈ fluence_DA_Nlay_cylinder_CW(cyl_2, besselroots[1:10000]) ≈ fluence_DA_semiinf_CW(1.0, 0.1, 10.0, n_med = 1.5, n_ext = 1.4)
